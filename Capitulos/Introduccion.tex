...
El sistema de compilación es TODO por la solución oficial de Rust: Cargo, que
...
Completamente todo en lo que se ha trabajado para este trabajo está disponible
públicamente:
...
\begin{itemize}
    ...
    \item Mi blog personal, en el que :
        \url{https://nullderef.com/series/rust-plugins/}.

        % TODO: actualizar '5' cuando suba el nuevo
        % TODO: actualizar minutos de lectura
        Para saber más información es altamente recomendado leer los 5 artículos
        en esa página web, que entran en gran detalle y suman 127 minutos de
        lectura.
\end{itemize}
