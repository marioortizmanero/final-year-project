...
\begin{itemize}
    ...
    \item \citetitle{zellij} es un entorno de trabajo en el terminal con ``un
    ...
    \item \citetitle{xi} es un editor de texto moderno ahora abandonado. Usaba
    ...
    \item \citetitle{bevy} es un motor de videojuegos prometedor cuyas
