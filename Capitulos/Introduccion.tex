...
de ítems de más de 11.000 proveedores globales~\cite{wayfairItems} y tiene unos
ingresos de 13.700 millones de dólares.

Se trata de una empresa de gran tamaño, por lo que dispone de una cantidad de
datos extraordinaria. En la mayoría de casos, esto se trata de \emph{logs}, es
decir, TODO. Muchas veces estos logs no siguen una misma estructura y requieren
algún tipo de procesado, así como ignorar aquellos innecesarios, o reducir su
tamaño. La arquitectura de estas tareas se basaba en:

\begin{itemize}
    \item ElasticSearch: motor de búsqueda basado en JSON.
    \item Logstash: recibir y procesar logs y datos no estructurados.
    \item Kibana: visualización de los datos
\end{itemize}

Sin embargo, a medida que crecía la empresa este stack dejó de escalar. Cada
día, procesaban 100 \emph{terabytes}. Si estos logs se escribieran en
papel, la montaña de papel resultante sería de unos 540 kilómetros, o en otras
palabras, 10 veces la distancia a la Estación Espacial Internacional. Su coste
llegaba a 40,000\$ mensuales\footnote{Las cantidades mencionadas en esta sección
no son completamente precisas, y se usan para dar una representación del tamaño
de datos procesados y su coste.}

El bottleneck principal se encontraba en Logstash, escrito en Java y sin un
enfoque especial en rendimiento.
