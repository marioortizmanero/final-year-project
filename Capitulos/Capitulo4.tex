...
la comunidad, como \cratelink{crossbeam} o \cratelink{serde_json}. La
...
\cratelink{safer_ffi} o \cratelink{cglue}, pero no son soluciones tan completas
...
\begin{itemize}
	\item El mismo Cargo\footnote{\url{https://github.com/rust-lang/cargo}} o
		...
		prefijo establecido (por ejemplo, \code{cargo-expand}). Si este binario
		está disponible en la variable de entorno \code{PATH} al ejecutar
		\code{cargo}, se podrá invocar al plugin con \code{cargo expand}
