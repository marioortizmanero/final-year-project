...
precedidos por la letra \code{R}. Por tanto, en vez de \code{Vec<T>}, podremos
usar \code{RVec<T>}; en caso contrario habría que recurrir a punteros
\code{*const T} o tendríamos que reescribir los tipos desde cero nosotros.
