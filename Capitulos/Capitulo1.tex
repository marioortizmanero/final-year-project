...
al repositorio). El conector no empieza a ejecutarse hasta que se conecte con
...
de un conector, comenzando por su registro en la
...
Ahora que tenemos un conector corriendo, visualizaremos cómo se divide en una
