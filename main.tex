...
% * Debería tener palabras anglosajonas con `\emph` siempre? Me parece que
% debería traducir 'connector' por 'conector', pero no sé cómo hacerlo en el
% caso de onramp, offramp, sink y source.
% * Traducir runtime por ejecutor?
% * Debería incluir las figuras siempre en su sitio, o siempre al final, o cómo?
...
% TODO: connector sí que se podría traducir por `conector`
\newcommand{\connector}{\emph{connector}\xspace}
\newcommand{\connectors}{\emph{connectors}\xspace}
