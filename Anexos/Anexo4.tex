...
hacía a \rust{RCow} invariante en \rust{'a}, en vez de covariante. Tenemos que
\rust{Cow<'a, T>} es covariante en tanto \rust{T} como \rust{'a}, pero nuestro
\rust{RCow<'a, T>} es covariante en \rust{T} e invariante en \rust{'a}.
