...
tomarse una decisión entre devolver \rust{RHashMap} o añadir una conversión
interna a \rust{HashMap}:
...
el tipo \rust{Cow}, cuya alternativa en la \crate \namecite{beef} ocupa menos
...
async fn user() {
    ...
    plugins con la \crate \code{async_ffi}. Este caso sigue el método de
...
\rust{Value}, es necesario convertir los tipos y posiblemente encapsularlo con
...
segunda versión~\cite{pdk_v2} añadió una versión encapsulada de \code{halbrown}
