...
\begin{itemize}
    ...
    \item No debe tener un impacto excesivo en el rendimiento. El equipo de
        ...
        poderse incluir en producción.

        Copiar eventos en cualquier momento implicaría la rotura de este
        requerimiento.
...
nulos o referencias colgantes. Se usa normalmente por maximizar el control y
